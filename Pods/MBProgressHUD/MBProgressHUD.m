...
//            
//            for (int i = 0; i < 28; i++) {
//                [loadArr addObject:[UIImage imageNamed:[NSString stringWithFormat:@"hud%ld",i+1]]];
//            }
//            
//            //设置动画数组
//            [(UIImageView *)indicator setAnimationImages:loadArr];
//            //设置动画播放次数
//            [(UIImageView *)indicator setAnimationRepeatCount:MAXFLOAT];
//            //设置动画播放时间
