...
- (void)showBrowseViewController:(UIViewController *)controller
//- (void)showBrowseViewController
{
//    UIViewController *rootViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
//    UIViewController *rootViewController = [(AppDelegate *)[[UIApplication sharedApplication] delegate] mainController];
    ...
    {
        _snapshotView = [controller.view snapshotViewAfterScreenUpdates:NO];
    }
